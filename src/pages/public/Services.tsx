    ...
    <div className="py-20 min-h-[calc(100vh-200px)] relative">
      <div className="container px-4 lg:px-8 mx-auto relative z-10">
        ...
        <div className="grid lg:grid-cols-2 gap-12 mb-20">
          <div>
             <h2 className="text-2xl font-bold mb-6 flex items-center gap-3 text-brand-green"><BookOpen className="text-brand-green"/> Junior Secondary (JS1 - JS3)</h2>
          ...
          <div>
            <h2 className="text-2xl font-bold mb-6 flex items-center gap-3 text-brand-green"><Microscope className="text-brand-pink"/> Senior Secondary (SS1 - SS3)</h2>
