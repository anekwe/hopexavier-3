...
-- Fix: Remove Not Null constraints for safe application inserts
DO $$ 
BEGIN
    ALTER TABLE public.applications ALTER COLUMN parent_full_name DROP NOT NULL;
    ALTER TABLE public.applications ALTER COLUMN student_full_name DROP NOT NULL;
    ALTER TABLE public.applications ALTER COLUMN student_type DROP NOT NULL;
