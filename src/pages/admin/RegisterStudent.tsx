  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const studentData = {
        ...
        parent_name: formData.parents_name,
        parent_full_name: formData.parents_name,
        parents_phone: formData.parents_phone,
        parent_phone: formData.parents_phone,
        phone: formData.parents_phone,
        email_address: formData.email_address,
        parent_email: formData.email_address,
